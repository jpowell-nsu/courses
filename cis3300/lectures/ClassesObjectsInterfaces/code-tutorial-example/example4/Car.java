 ...
 * Car
 *
 * Example 4 version: adds overridden toString, equals, and hashCode on top
 * of the Day 1 version, so two Cars with the same make, model, and year
 * compare and print the way a person would expect.
 *
 * @author  CIS 3300
 * @version 1.1
 */
