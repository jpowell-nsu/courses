...
public class DroidDriver {
	...
	public static void main(String[] args) {
		...
		droid = new Droid("Something");
		droids.add(4, droid);
		
		droid = new Droid("Something something dark side");
		droids.add(4, droid);
		
		droid = new Droid("Something something");
		droids.add(5, droid);
		
		droid = new Droid("Something something something");
		droids.add(6, droid);
